   ...
   <div class="row" style="padding-top:40px">
    <div class="col-6 col-s-6">
     <h2 style="text-align:center;color:black">CONTACT US</h2>
      <div class="container">
        <form action="PHP/contact.php" target="_blank" method="post" autocomplete="on">
           ...
           <p style="text-align:center;font-size:18px"><input type="tel" name="phone" placeholder="Phone Number" required style="width:70%"></p>
    ...
    <div class="col-6 col-s-12 w3-center">
      ...
      <p style="font-size:14px;padding:15px;color:black;font-weight:bolder">0700000000</P>
        ...
        <p style="font-size:14px;padding:15px;color:black;font-weight:bolder">topbnb@gmail.com</p>
      ...
      <a target="_blank" href="#" style="font-size:14px;color:black" class="fa fa-facebook w3-hover-blue "></a>
      <a target="_blank" href="#" style="font-size:14px;color:black" class="fa fa-twitter w3-hover-blue"></a>
      <a target="_blank" href="#" style="font-size:14px;color:black" class="fa fa-instagram w3-hover-purple"></a>
    </div>
   </div>
